...
但是如果新颜色的透明度不是 255，而是**半透明**，比如 120，那么“混合”模式下，会将新颜色与原本的颜色进行混合，比如要画上去的颜色是 (0, 0, 255, 120)（请参考[RGB 颜色系统]({{ site.baseurl }}{% link _tutorials/rgb_hsv.md %}#rgb颜色系统)），原本的颜色是 (255, 0, 0, 120)，那么混合之后的颜色是 (87, 0, 167, 183)。
